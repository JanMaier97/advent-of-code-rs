...
impl Emulator {
    ...
    fn handle_div(&mut self, target: Register, operand: ComboOp) {
        ...
        let denominator = 2_u32.pow(op_value);
    ...
    fn get_operand_value(&self, op: ComboOp) -> u32 {
        match op {
            ComboOp::Value(i) => i as u32,
